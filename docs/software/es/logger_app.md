...
- [iPhone/iPad(App Store)](https://apps.apple.com/jp/app/jins-meme-logger/id1537937129) iOS/iPadOS 13.0以降, BLE4.2以降搭載端末
- [Android 12以降(Play Store)](https://play.google.com/store/apps/details?id=com.jins_meme.logger4internal) BLE4.2以降搭載端末
