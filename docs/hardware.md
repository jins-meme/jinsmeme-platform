...
| データ通信 | ・Bluetooth Low Energyによる無線通信<br />・電波到達距離 最大7m程度 |
...
- ご購入は以下の流れになります。販売・発送・お支払いは日本に拠点のある法人のみ対応可能となっております（個人向けは非対応）。
...
商品を受領しましたら、ご請求書に記載の方法（銀行振込）で法人名義でお支払いください。クレジット決済、コンビニ決済等には対応しておりません。
