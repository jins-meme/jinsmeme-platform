# Academic(ES-R) Logger for Android<Badge type="danger" text="Academic" />

The data acquired with the JINS MEME ES_R can be saved on an Android device.

> **Note:** This page describes the previous app (**up to version 2**). If you are using version 3 or later, see the [new app manual](./index.html).

## Downloading the Software

- Please download from [here](https://github.com/jins-meme/ES_R-DataLogger/releases).
  - Android 8 or later, devices with BLE4.2 or later
...
4. Tap `Only when using apps` when the location grant dialog is displayed (older Androids only show allow/not allow).
